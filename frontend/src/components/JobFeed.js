        ...
        {data.jobs.map((job) => (
          <div key={job.id} className="group ui-glass ui-card-hover p-8 rounded-3xl border border-slate-100 flex flex-col justify-between">
            ...
            <button 
              ...
              className="w-full bg-gradient-to-r from-slate-900 to-slate-700 text-white py-4 rounded-2xl font-black hover:from-teal-600 hover:to-cyan-600 transition-all active:scale-95 shadow-lg shadow-slate-200"
            >
              Apply Now
            </button>
          </div>
